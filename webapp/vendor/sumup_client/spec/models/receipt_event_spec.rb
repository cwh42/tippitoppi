...
# Unit tests for OpenapiClient::ReceiptEvent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptEvent do
  let(:instance) { OpenapiClient::ReceiptEvent.new }

  describe 'test an instance of ReceiptEvent' do
    it 'should create an instance of ReceiptEvent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptEvent)
    end
  end
