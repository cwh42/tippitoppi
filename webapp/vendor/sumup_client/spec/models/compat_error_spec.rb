...
# Unit tests for OpenapiClient::CompatError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompatError do
  let(:instance) { OpenapiClient::CompatError.new }

  describe 'test an instance of CompatError' do
    it 'should create an instance of CompatError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CompatError)
    end
  end
