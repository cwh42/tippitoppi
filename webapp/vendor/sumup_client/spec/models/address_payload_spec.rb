...
# Unit tests for OpenapiClient::AddressPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AddressPayload do
  let(:instance) { OpenapiClient::AddressPayload.new }

  describe 'test an instance of AddressPayload' do
    it 'should create an instance of AddressPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AddressPayload)
    end
  end
