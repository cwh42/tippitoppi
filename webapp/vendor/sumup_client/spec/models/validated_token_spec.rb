...
# Unit tests for OpenapiClient::ValidatedToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ValidatedToken do
  let(:instance) { OpenapiClient::ValidatedToken.new }

  describe 'test an instance of ValidatedToken' do
    it 'should create an instance of ValidatedToken' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ValidatedToken)
    end
  end
