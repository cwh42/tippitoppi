...
# Unit tests for OpenapiClient::DetailsError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DetailsError do
  let(:instance) { OpenapiClient::DetailsError.new }

  describe 'test an instance of DetailsError' do
    it 'should create an instance of DetailsError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DetailsError)
    end
  end
  ...
  describe 'test attribute "failed_constraints"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
