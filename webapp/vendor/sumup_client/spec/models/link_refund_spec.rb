...
# Unit tests for OpenapiClient::LinkRefund
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LinkRefund do
  let(:instance) { OpenapiClient::LinkRefund.new }

  describe 'test an instance of LinkRefund' do
    it 'should create an instance of LinkRefund' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::LinkRefund)
    end
  end
