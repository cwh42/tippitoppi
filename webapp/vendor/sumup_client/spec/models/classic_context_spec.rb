...
# Unit tests for OpenapiClient::ClassicContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ClassicContext do
  let(:instance) { OpenapiClient::ClassicContext.new }

  describe 'test an instance of ClassicContext' do
    it 'should create an instance of ClassicContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ClassicContext)
    end
  end
