...
# Unit tests for OpenapiClient::CreateReaderCheckout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout do
  let(:instance) { OpenapiClient::CreateReaderCheckout.new }

  describe 'test an instance of CreateReaderCheckout' do
    it 'should create an instance of CreateReaderCheckout' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout)
    end
  end
