...
# Unit tests for OpenapiClient::CreateReaderCheckout201ResponseData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout201ResponseData do
  let(:instance) { OpenapiClient::CreateReaderCheckout201ResponseData.new }

  describe 'test an instance of CreateReaderCheckout201ResponseData' do
    it 'should create an instance of CreateReaderCheckout201ResponseData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout201ResponseData)
    end
  end
