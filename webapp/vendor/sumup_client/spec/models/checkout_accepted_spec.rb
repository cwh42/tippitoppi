...
# Unit tests for OpenapiClient::CheckoutAccepted
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CheckoutAccepted do
  let(:instance) { OpenapiClient::CheckoutAccepted.new }

  describe 'test an instance of CheckoutAccepted' do
    it 'should create an instance of CheckoutAccepted' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CheckoutAccepted)
    end
  end
