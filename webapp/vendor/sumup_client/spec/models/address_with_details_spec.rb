...
# Unit tests for OpenapiClient::AddressWithDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AddressWithDetails do
  let(:instance) { OpenapiClient::AddressWithDetails.new }

  describe 'test an instance of AddressWithDetails' do
    it 'should create an instance of AddressWithDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AddressWithDetails)
    end
  end
  ...
  describe 'test attribute "country_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "timeoffset_details"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
