...
# Unit tests for OpenapiClient::AuthCode
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthCode do
  let(:instance) { OpenapiClient::AuthCode.new }

  describe 'test an instance of AuthCode' do
    it 'should create an instance of AuthCode' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AuthCode)
    end
  end
