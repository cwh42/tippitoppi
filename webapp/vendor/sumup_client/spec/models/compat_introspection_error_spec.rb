...
# Unit tests for OpenapiClient::CompatIntrospectionError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompatIntrospectionError do
  let(:instance) { OpenapiClient::CompatIntrospectionError.new }

  describe 'test an instance of CompatIntrospectionError' do
    it 'should create an instance of CompatIntrospectionError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CompatIntrospectionError)
    end
  end
