...
# Unit tests for OpenapiClient::SignupVerificationStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SignupVerificationStatus do
  let(:instance) { OpenapiClient::SignupVerificationStatus.new }

  describe 'test an instance of SignupVerificationStatus' do
    it 'should create an instance of SignupVerificationStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SignupVerificationStatus)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["pending", "verified", "claimed"])
