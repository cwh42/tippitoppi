...
# Unit tests for OpenapiClient::CreateReaderCheckout500ResponseErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout500ResponseErrors do
  let(:instance) { OpenapiClient::CreateReaderCheckout500ResponseErrors.new }

  describe 'test an instance of CreateReaderCheckout500ResponseErrors' do
    it 'should create an instance of CreateReaderCheckout500ResponseErrors' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout500ResponseErrors)
    end
  end
