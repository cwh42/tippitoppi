...
# Unit tests for OpenapiClient::ReceiptTransactionVatRatesInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptTransactionVatRatesInner do
  let(:instance) { OpenapiClient::ReceiptTransactionVatRatesInner.new }

  describe 'test an instance of ReceiptTransactionVatRatesInner' do
    it 'should create an instance of ReceiptTransactionVatRatesInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptTransactionVatRatesInner)
    end
  end
