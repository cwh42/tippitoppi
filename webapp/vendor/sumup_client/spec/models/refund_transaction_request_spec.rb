...
# Unit tests for OpenapiClient::RefundTransactionRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RefundTransactionRequest do
  let(:instance) { OpenapiClient::RefundTransactionRequest.new }

  describe 'test an instance of RefundTransactionRequest' do
    it 'should create an instance of RefundTransactionRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::RefundTransactionRequest)
    end
  end
