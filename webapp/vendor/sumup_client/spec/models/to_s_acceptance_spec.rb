...
# Unit tests for OpenapiClient::ToSAcceptance
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ToSAcceptance do
  let(:instance) { OpenapiClient::ToSAcceptance.new }

  describe 'test an instance of ToSAcceptance' do
    it 'should create an instance of ToSAcceptance' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ToSAcceptance)
    end
  end
