...
# Unit tests for OpenapiClient::CreateMerchantMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateMerchantMemberRequest do
  let(:instance) { OpenapiClient::CreateMerchantMemberRequest.new }

  describe 'test an instance of CreateMerchantMemberRequest' do
    it 'should create an instance of CreateMerchantMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateMerchantMemberRequest)
    end
  end

  describe 'test attribute "is_managed_user"' do
    it 'should work' do
