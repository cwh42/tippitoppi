...
# Unit tests for OpenapiClient::ListTransactionsV21200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListTransactionsV21200Response do
  let(:instance) { OpenapiClient::ListTransactionsV21200Response.new }

  describe 'test an instance of ListTransactionsV21200Response' do
    it 'should create an instance of ListTransactionsV21200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListTransactionsV21200Response)
    end
  end
