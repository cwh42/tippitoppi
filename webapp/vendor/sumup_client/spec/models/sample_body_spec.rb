...
# Unit tests for OpenapiClient::SampleBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SampleBody do
  let(:instance) { OpenapiClient::SampleBody.new }

  describe 'test an instance of SampleBody' do
    it 'should create an instance of SampleBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SampleBody)
    end
  end
