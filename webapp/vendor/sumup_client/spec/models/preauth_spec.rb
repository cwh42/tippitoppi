...
# Unit tests for OpenapiClient::Preauth
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Preauth do
  let(:instance) { OpenapiClient::Preauth.new }

  describe 'test an instance of Preauth' do
    it 'should create an instance of Preauth' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Preauth)
    end
  end
