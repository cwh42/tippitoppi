...
# Unit tests for OpenapiClient::TokenError
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TokenError do
  let(:instance) { OpenapiClient::TokenError.new }

  describe 'test an instance of TokenError' do
    it 'should create an instance of TokenError' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TokenError)
    end
  end
