...
# Unit tests for OpenapiClient::CheckoutAcceptedNextStep
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CheckoutAcceptedNextStep do
  let(:instance) { OpenapiClient::CheckoutAcceptedNextStep.new }

  describe 'test an instance of CheckoutAcceptedNextStep' do
    it 'should create an instance of CheckoutAcceptedNextStep' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CheckoutAcceptedNextStep)
    end
  end
  ...
  describe 'test attribute "mechanism"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["iframe", "browser"])
      # validator.allowable_values.each do |value|
      #   expect { instance.mechanism = value }.not_to raise_error
      # end
    end
  end
