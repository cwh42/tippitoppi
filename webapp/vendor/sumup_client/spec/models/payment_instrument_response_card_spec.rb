...
# Unit tests for OpenapiClient::PaymentInstrumentResponseCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentInstrumentResponseCard do
  let(:instance) { OpenapiClient::PaymentInstrumentResponseCard.new }

  describe 'test an instance of PaymentInstrumentResponseCard' do
    it 'should create an instance of PaymentInstrumentResponseCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PaymentInstrumentResponseCard)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["AMEX", "CUP", "DINERS", "DISCOVER", "ELO", "ELV", "HIPERCARD", "JCB", "MAESTRO", "MASTERCARD", "VISA", "VISA_ELECTRON", "VISA_VPAY", "UNKNOWN"])
