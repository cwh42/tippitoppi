...
# Unit tests for OpenapiClient::PaymentInstrumentResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentInstrumentResponse do
  let(:instance) { OpenapiClient::PaymentInstrumentResponse.new }

  describe 'test an instance of PaymentInstrumentResponse' do
    it 'should create an instance of PaymentInstrumentResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PaymentInstrumentResponse)
    end
  end
