...
# Unit tests for OpenapiClient::LegacyOTP
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LegacyOTP do
  let(:instance) { OpenapiClient::LegacyOTP.new }

  describe 'test an instance of LegacyOTP' do
    it 'should create an instance of LegacyOTP' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::LegacyOTP)
    end
  end
