...
# Unit tests for OpenapiClient::GetPaymentMethods200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetPaymentMethods200Response do
  let(:instance) { OpenapiClient::GetPaymentMethods200Response.new }

  describe 'test an instance of GetPaymentMethods200Response' do
    it 'should create an instance of GetPaymentMethods200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetPaymentMethods200Response)
    end
  end

  describe 'test attribute "available_payment_methods"' do
    it 'should work' do
