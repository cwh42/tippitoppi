...
# Unit tests for OpenapiClient::CheckoutSuccessAllOfPaymentInstrument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CheckoutSuccessAllOfPaymentInstrument do
  let(:instance) { OpenapiClient::CheckoutSuccessAllOfPaymentInstrument.new }

  describe 'test an instance of CheckoutSuccessAllOfPaymentInstrument' do
    it 'should create an instance of CheckoutSuccessAllOfPaymentInstrument' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CheckoutSuccessAllOfPaymentInstrument)
    end
  end
