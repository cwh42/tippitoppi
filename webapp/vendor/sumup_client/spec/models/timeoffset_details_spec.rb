...
# Unit tests for OpenapiClient::TimeoffsetDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TimeoffsetDetails do
  let(:instance) { OpenapiClient::TimeoffsetDetails.new }

  describe 'test an instance of TimeoffsetDetails' do
    it 'should create an instance of TimeoffsetDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TimeoffsetDetails)
    end
  end
