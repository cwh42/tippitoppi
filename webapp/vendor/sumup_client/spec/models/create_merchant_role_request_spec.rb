...
# Unit tests for OpenapiClient::CreateMerchantRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateMerchantRoleRequest do
  let(:instance) { OpenapiClient::CreateMerchantRoleRequest.new }

  describe 'test an instance of CreateMerchantRoleRequest' do
    it 'should create an instance of CreateMerchantRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateMerchantRoleRequest)
    end
  end
