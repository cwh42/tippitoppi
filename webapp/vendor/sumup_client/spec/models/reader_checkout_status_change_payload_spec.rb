...
# Unit tests for OpenapiClient::ReaderCheckoutStatusChangePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReaderCheckoutStatusChangePayload do
  let(:instance) { OpenapiClient::ReaderCheckoutStatusChangePayload.new }

  describe 'test an instance of ReaderCheckoutStatusChangePayload' do
    it 'should create an instance of ReaderCheckoutStatusChangePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReaderCheckoutStatusChangePayload)
    end
  end
