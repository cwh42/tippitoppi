...
# Unit tests for OpenapiClient::UpdateSubAccountRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateSubAccountRequest do
  let(:instance) { OpenapiClient::UpdateSubAccountRequest.new }

  describe 'test an instance of UpdateSubAccountRequest' do
    it 'should create an instance of UpdateSubAccountRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateSubAccountRequest)
    end
  end
