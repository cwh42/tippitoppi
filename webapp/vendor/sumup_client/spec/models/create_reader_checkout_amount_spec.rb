...
# Unit tests for OpenapiClient::CreateReaderCheckoutAmount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckoutAmount do
  let(:instance) { OpenapiClient::CreateReaderCheckoutAmount.new }

  describe 'test an instance of CreateReaderCheckoutAmount' do
    it 'should create an instance of CreateReaderCheckoutAmount' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckoutAmount)
    end
  end
