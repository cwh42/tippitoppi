...
# Unit tests for OpenapiClient::BankAccountPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BankAccountPayload do
  let(:instance) { OpenapiClient::BankAccountPayload.new }

  describe 'test an instance of BankAccountPayload' do
    it 'should create an instance of BankAccountPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BankAccountPayload)
    end
  end
  ...
  describe 'test attribute "account_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CURRENT", "SAVINGS"])
