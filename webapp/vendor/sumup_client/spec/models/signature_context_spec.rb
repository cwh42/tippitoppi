...
# Unit tests for OpenapiClient::SignatureContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SignatureContext do
  let(:instance) { OpenapiClient::SignatureContext.new }

  describe 'test an instance of SignatureContext' do
    it 'should create an instance of SignatureContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SignatureContext)
    end
  end

  describe 'test attribute "body_digest"' do
    it 'should work' do
  ...
  describe 'test attribute "amr"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["otp", "swk", "sms", "email"])
      # validator.allowable_values.each do |value|
      #   expect { instance.amr = value }.not_to raise_error
      # end
    end
  end
