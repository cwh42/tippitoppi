...
# Unit tests for OpenapiClient::VatRates
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::VatRates do
  let(:instance) { OpenapiClient::VatRates.new }

  describe 'test an instance of VatRates' do
    it 'should create an instance of VatRates' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::VatRates)
    end
  end
