...
# Unit tests for OpenapiClient::DeactivateCheckout200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeactivateCheckout200Response do
  let(:instance) { OpenapiClient::DeactivateCheckout200Response.new }

  describe 'test an instance of DeactivateCheckout200Response' do
    it 'should create an instance of DeactivateCheckout200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeactivateCheckout200Response)
    end
  end
  ...
  describe 'test attribute "purpose"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["SETUP_RECURRING_PAYMENT", "CHECKOUT"])
