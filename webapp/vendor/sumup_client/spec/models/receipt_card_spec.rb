...
# Unit tests for OpenapiClient::ReceiptCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptCard do
  let(:instance) { OpenapiClient::ReceiptCard.new }

  describe 'test an instance of ReceiptCard' do
    it 'should create an instance of ReceiptCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptCard)
    end
  end
