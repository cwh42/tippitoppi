...
# Unit tests for OpenapiClient::LegalType
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::LegalType do
  let(:instance) { OpenapiClient::LegalType.new }

  describe 'test an instance of LegalType' do
    it 'should create an instance of LegalType' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::LegalType)
    end
  end
  ...
  describe 'test attribute "sole_trader"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
