...
# Unit tests for OpenapiClient::PersonalProfilePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PersonalProfilePayload do
  let(:instance) { OpenapiClient::PersonalProfilePayload.new }

  describe 'test an instance of PersonalProfilePayload' do
    it 'should create an instance of PersonalProfilePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PersonalProfilePayload)
    end
  end
