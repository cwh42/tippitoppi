...
# Unit tests for OpenapiClient::ReceiptMerchantDataMerchantProfileAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptMerchantDataMerchantProfileAddress do
  let(:instance) { OpenapiClient::ReceiptMerchantDataMerchantProfileAddress.new }

  describe 'test an instance of ReceiptMerchantDataMerchantProfileAddress' do
    it 'should create an instance of ReceiptMerchantDataMerchantProfileAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptMerchantDataMerchantProfileAddress)
    end
  end
  ...
  describe 'test attribute "country_en_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "country_native_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
