...
# Unit tests for OpenapiClient::MandateResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MandateResponse do
  let(:instance) { OpenapiClient::MandateResponse.new }

  describe 'test an instance of MandateResponse' do
    it 'should create an instance of MandateResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MandateResponse)
    end
  end
