...
# Unit tests for OpenapiClient::DeviceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DeviceRequest do
  let(:instance) { OpenapiClient::DeviceRequest.new }

  describe 'test an instance of DeviceRequest' do
    it 'should create an instance of DeviceRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DeviceRequest)
    end
  end

  describe 'test attribute "platform_device_id"' do
    it 'should work' do
