...
# Unit tests for OpenapiClient::OTPChannel
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OTPChannel do
  let(:instance) { OpenapiClient::OTPChannel.new }

  describe 'test an instance of OTPChannel' do
    it 'should create an instance of OTPChannel' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OTPChannel)
    end
  end
