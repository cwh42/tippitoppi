...
# Unit tests for OpenapiClient::AuthorizationContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthorizationContext do
  let(:instance) { OpenapiClient::AuthorizationContext.new }

  describe 'test an instance of AuthorizationContext' do
    it 'should create an instance of AuthorizationContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AuthorizationContext)
    end
  end
