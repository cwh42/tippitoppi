...
# Unit tests for OpenapiClient::ErrorForbidden
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorForbidden do
  let(:instance) { OpenapiClient::ErrorForbidden.new }

  describe 'test an instance of ErrorForbidden' do
    it 'should create an instance of ErrorForbidden' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ErrorForbidden)
    end
  end
