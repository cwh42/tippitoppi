...
# Unit tests for OpenapiClient::CreateReaderCheckout502Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout502Response do
  let(:instance) { OpenapiClient::CreateReaderCheckout502Response.new }

  describe 'test an instance of CreateReaderCheckout502Response' do
    it 'should create an instance of CreateReaderCheckout502Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout502Response)
    end
  end
