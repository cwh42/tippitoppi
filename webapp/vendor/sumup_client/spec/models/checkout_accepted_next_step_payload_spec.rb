...
# Unit tests for OpenapiClient::CheckoutAcceptedNextStepPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CheckoutAcceptedNextStepPayload do
  let(:instance) { OpenapiClient::CheckoutAcceptedNextStepPayload.new }

  describe 'test an instance of CheckoutAcceptedNextStepPayload' do
    it 'should create an instance of CheckoutAcceptedNextStepPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CheckoutAcceptedNextStepPayload)
    end
  end
