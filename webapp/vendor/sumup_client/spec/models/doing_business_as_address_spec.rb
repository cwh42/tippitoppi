...
# Unit tests for OpenapiClient::DoingBusinessAsAddress
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DoingBusinessAsAddress do
  let(:instance) { OpenapiClient::DoingBusinessAsAddress.new }

  describe 'test an instance of DoingBusinessAsAddress' do
    it 'should create an instance of DoingBusinessAsAddress' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DoingBusinessAsAddress)
    end
  end
