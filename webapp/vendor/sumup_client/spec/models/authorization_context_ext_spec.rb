...
# Unit tests for OpenapiClient::AuthorizationContextExt
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthorizationContextExt do
  let(:instance) { OpenapiClient::AuthorizationContextExt.new }

  describe 'test an instance of AuthorizationContextExt' do
    it 'should create an instance of AuthorizationContextExt' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AuthorizationContextExt)
    end
  end
