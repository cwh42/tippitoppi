...
# Unit tests for OpenapiClient::CreateReaderCheckout400ResponseErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout400ResponseErrors do
  let(:instance) { OpenapiClient::CreateReaderCheckout400ResponseErrors.new }

  describe 'test an instance of CreateReaderCheckout400ResponseErrors' do
    it 'should create an instance of CreateReaderCheckout400ResponseErrors' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout400ResponseErrors)
    end
  end
