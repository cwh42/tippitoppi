...
# Unit tests for OpenapiClient::ReaderDevice
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReaderDevice do
  let(:instance) { OpenapiClient::ReaderDevice.new }

  describe 'test an instance of ReaderDevice' do
    it 'should create an instance of ReaderDevice' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReaderDevice)
    end
  end
  ...
  describe 'test attribute "model"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["solo", "virtual-solo"])
