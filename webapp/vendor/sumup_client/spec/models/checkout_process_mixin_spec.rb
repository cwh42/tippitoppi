...
# Unit tests for OpenapiClient::CheckoutProcessMixin
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CheckoutProcessMixin do
  let(:instance) { OpenapiClient::CheckoutProcessMixin.new }

  describe 'test an instance of CheckoutProcessMixin' do
    it 'should create an instance of CheckoutProcessMixin' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CheckoutProcessMixin)
    end
  end
  ...
  describe 'test attribute "payment_type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["card", "boleto", "ideal", "blik", "bancontact"])
