...
# Unit tests for OpenapiClient::MembershipUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MembershipUser do
  let(:instance) { OpenapiClient::MembershipUser.new }

  describe 'test an instance of MembershipUser' do
    it 'should create an instance of MembershipUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MembershipUser)
    end
  end
  ...
  describe 'test attribute "virtual_user"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "service_account_user"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
