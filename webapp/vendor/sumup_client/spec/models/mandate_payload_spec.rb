...
# Unit tests for OpenapiClient::MandatePayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MandatePayload do
  let(:instance) { OpenapiClient::MandatePayload.new }

  describe 'test an instance of MandatePayload' do
    it 'should create an instance of MandatePayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MandatePayload)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["recurrent"])
