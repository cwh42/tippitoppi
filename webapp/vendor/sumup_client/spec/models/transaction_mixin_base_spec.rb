...
# Unit tests for OpenapiClient::TransactionMixinBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TransactionMixinBase do
  let(:instance) { OpenapiClient::TransactionMixinBase.new }

  describe 'test an instance of TransactionMixinBase' do
    it 'should create an instance of TransactionMixinBase' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TransactionMixinBase)
    end
  end
