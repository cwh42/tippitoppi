...
# Unit tests for OpenapiClient::ReaderStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReaderStatus do
  let(:instance) { OpenapiClient::ReaderStatus.new }

  describe 'test an instance of ReaderStatus' do
    it 'should create an instance of ReaderStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReaderStatus)
    end
  end
