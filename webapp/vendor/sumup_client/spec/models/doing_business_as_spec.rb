...
# Unit tests for OpenapiClient::DoingBusinessAs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DoingBusinessAs do
  let(:instance) { OpenapiClient::DoingBusinessAs.new }

  describe 'test an instance of DoingBusinessAs' do
    it 'should create an instance of DoingBusinessAs' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DoingBusinessAs)
    end
  end
