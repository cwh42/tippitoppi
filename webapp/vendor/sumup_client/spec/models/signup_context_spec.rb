...
# Unit tests for OpenapiClient::SignupContext
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SignupContext do
  let(:instance) { OpenapiClient::SignupContext.new }

  describe 'test an instance of SignupContext' do
    it 'should create an instance of SignupContext' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::SignupContext)
    end
  end
