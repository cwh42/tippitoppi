...
# Unit tests for OpenapiClient::UpdateMerchantMemberRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateMerchantMemberRequest do
  let(:instance) { OpenapiClient::UpdateMerchantMemberRequest.new }

  describe 'test an instance of UpdateMerchantMemberRequest' do
    it 'should create an instance of UpdateMerchantMemberRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateMerchantMemberRequest)
    end
  end
