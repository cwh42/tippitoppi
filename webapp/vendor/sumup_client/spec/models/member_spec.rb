...
# Unit tests for OpenapiClient::Member
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Member do
  let(:instance) { OpenapiClient::Member.new }

  describe 'test an instance of Member' do
    it 'should create an instance of Member' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Member)
    end
  end
