...
# Unit tests for OpenapiClient::Checkout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Checkout do
  let(:instance) { OpenapiClient::Checkout.new }

  describe 'test an instance of Checkout' do
    it 'should create an instance of Checkout' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Checkout)
    end
  end
