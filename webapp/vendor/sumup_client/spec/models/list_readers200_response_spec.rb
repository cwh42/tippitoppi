...
# Unit tests for OpenapiClient::ListReaders200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListReaders200Response do
  let(:instance) { OpenapiClient::ListReaders200Response.new }

  describe 'test an instance of ListReaders200Response' do
    it 'should create an instance of ListReaders200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListReaders200Response)
    end
  end
