...
# Unit tests for OpenapiClient::UpdateReaderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateReaderRequest do
  let(:instance) { OpenapiClient::UpdateReaderRequest.new }

  describe 'test an instance of UpdateReaderRequest' do
    it 'should create an instance of UpdateReaderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateReaderRequest)
    end
  end
