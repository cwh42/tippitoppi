...
# Unit tests for OpenapiClient::ReceiptAcquirerData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptAcquirerData do
  let(:instance) { OpenapiClient::ReceiptAcquirerData.new }

  describe 'test an instance of ReceiptAcquirerData' do
    it 'should create an instance of ReceiptAcquirerData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptAcquirerData)
    end
  end
