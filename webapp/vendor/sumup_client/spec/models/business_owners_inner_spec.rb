...
# Unit tests for OpenapiClient::BusinessOwnersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BusinessOwnersInner do
  let(:instance) { OpenapiClient::BusinessOwnersInner.new }

  describe 'test an instance of BusinessOwnersInner' do
    it 'should create an instance of BusinessOwnersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BusinessOwnersInner)
    end
  end
