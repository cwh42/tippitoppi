...
# Unit tests for OpenapiClient::CreateSubAccountRequestPermissions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateSubAccountRequestPermissions do
  let(:instance) { OpenapiClient::CreateSubAccountRequestPermissions.new }

  describe 'test an instance of CreateSubAccountRequestPermissions' do
    it 'should create an instance of CreateSubAccountRequestPermissions' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateSubAccountRequestPermissions)
    end
  end

  describe 'test attribute "create_moto_payments"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "create_referral"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "full_transaction_history_view"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
