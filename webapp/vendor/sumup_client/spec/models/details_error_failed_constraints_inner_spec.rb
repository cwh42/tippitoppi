...
# Unit tests for OpenapiClient::DetailsErrorFailedConstraintsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DetailsErrorFailedConstraintsInner do
  let(:instance) { OpenapiClient::DetailsErrorFailedConstraintsInner.new }

  describe 'test an instance of DetailsErrorFailedConstraintsInner' do
    it 'should create an instance of DetailsErrorFailedConstraintsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DetailsErrorFailedConstraintsInner)
    end
  end
