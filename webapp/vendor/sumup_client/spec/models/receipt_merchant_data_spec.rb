...
# Unit tests for OpenapiClient::ReceiptMerchantData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptMerchantData do
  let(:instance) { OpenapiClient::ReceiptMerchantData.new }

  describe 'test an instance of ReceiptMerchantData' do
    it 'should create an instance of ReceiptMerchantData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptMerchantData)
    end
  end
