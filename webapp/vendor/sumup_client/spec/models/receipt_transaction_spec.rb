...
# Unit tests for OpenapiClient::ReceiptTransaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptTransaction do
  let(:instance) { OpenapiClient::ReceiptTransaction.new }

  describe 'test an instance of ReceiptTransaction' do
    it 'should create an instance of ReceiptTransaction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptTransaction)
    end
  end
  ...
  describe 'test attribute "receipt_no"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
