...
# Unit tests for OpenapiClient::MerchantProfilePayloadDoingBusinessAs
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MerchantProfilePayloadDoingBusinessAs do
  let(:instance) { OpenapiClient::MerchantProfilePayloadDoingBusinessAs.new }

  describe 'test an instance of MerchantProfilePayloadDoingBusinessAs' do
    it 'should create an instance of MerchantProfilePayloadDoingBusinessAs' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MerchantProfilePayloadDoingBusinessAs)
    end
  end
