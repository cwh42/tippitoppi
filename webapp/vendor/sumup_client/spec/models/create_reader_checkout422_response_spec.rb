...
# Unit tests for OpenapiClient::CreateReaderCheckout422Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout422Response do
  let(:instance) { OpenapiClient::CreateReaderCheckout422Response.new }

  describe 'test an instance of CreateReaderCheckout422Response' do
    it 'should create an instance of CreateReaderCheckout422Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout422Response)
    end
  end
