...
# Unit tests for OpenapiClient::PersonalDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PersonalDetails do
  let(:instance) { OpenapiClient::PersonalDetails.new }

  describe 'test an instance of PersonalDetails' do
    it 'should create an instance of PersonalDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PersonalDetails)
    end
  end
