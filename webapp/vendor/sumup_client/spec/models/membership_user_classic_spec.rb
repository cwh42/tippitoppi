...
# Unit tests for OpenapiClient::MembershipUserClassic
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MembershipUserClassic do
  let(:instance) { OpenapiClient::MembershipUserClassic.new }

  describe 'test an instance of MembershipUserClassic' do
    it 'should create an instance of MembershipUserClassic' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MembershipUserClassic)
    end
  end
