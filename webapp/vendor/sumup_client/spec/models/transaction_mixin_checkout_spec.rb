...
# Unit tests for OpenapiClient::TransactionMixinCheckout
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TransactionMixinCheckout do
  let(:instance) { OpenapiClient::TransactionMixinCheckout.new }

  describe 'test an instance of TransactionMixinCheckout' do
    it 'should create an instance of TransactionMixinCheckout' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TransactionMixinCheckout)
    end
  end
