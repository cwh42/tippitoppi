...
# Unit tests for OpenapiClient::CreateReaderCheckout504Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout504Response do
  let(:instance) { OpenapiClient::CreateReaderCheckout504Response.new }

  describe 'test an instance of CreateReaderCheckout504Response' do
    it 'should create an instance of CreateReaderCheckout504Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout504Response)
    end
  end
