...
# Unit tests for OpenapiClient::CreateReaderCheckout201Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout201Response do
  let(:instance) { OpenapiClient::CreateReaderCheckout201Response.new }

  describe 'test an instance of CreateReaderCheckout201Response' do
    it 'should create an instance of CreateReaderCheckout201Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout201Response)
    end
  end
