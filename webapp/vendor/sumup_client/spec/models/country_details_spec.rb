...
# Unit tests for OpenapiClient::CountryDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CountryDetails do
  let(:instance) { OpenapiClient::CountryDetails.new }

  describe 'test an instance of CountryDetails' do
    it 'should create an instance of CountryDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CountryDetails)
    end
  end
