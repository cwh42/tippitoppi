...
# Unit tests for OpenapiClient::CreateReaderCheckout400Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout400Response do
  let(:instance) { OpenapiClient::CreateReaderCheckout400Response.new }

  describe 'test an instance of CreateReaderCheckout400Response' do
    it 'should create an instance of CreateReaderCheckout400Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout400Response)
    end
  end
