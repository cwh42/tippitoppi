...
# Unit tests for OpenapiClient::CreateReaderCheckout502ResponseErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout502ResponseErrors do
  let(:instance) { OpenapiClient::CreateReaderCheckout502ResponseErrors.new }

  describe 'test an instance of CreateReaderCheckout502ResponseErrors' do
    it 'should create an instance of CreateReaderCheckout502ResponseErrors' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout502ResponseErrors)
    end
  end
