...
# Unit tests for OpenapiClient::ListMemberships200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListMemberships200Response do
  let(:instance) { OpenapiClient::ListMemberships200Response.new }

  describe 'test an instance of ListMemberships200Response' do
    it 'should create an instance of ListMemberships200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListMemberships200Response)
    end
  end
