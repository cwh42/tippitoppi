...
# Unit tests for OpenapiClient::MerchantProfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MerchantProfile do
  let(:instance) { OpenapiClient::MerchantProfile.new }

  describe 'test an instance of MerchantProfile' do
    it 'should create an instance of MerchantProfile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MerchantProfile)
    end
  end
  ...
  describe 'test attribute "extdev"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "payout_zone_migrated"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
