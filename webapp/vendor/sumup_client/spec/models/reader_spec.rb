...
# Unit tests for OpenapiClient::Reader
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Reader do
  let(:instance) { OpenapiClient::Reader.new }

  describe 'test an instance of Reader' do
    it 'should create an instance of Reader' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Reader)
    end
  end
