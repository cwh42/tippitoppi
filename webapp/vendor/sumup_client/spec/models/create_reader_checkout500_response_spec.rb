...
# Unit tests for OpenapiClient::CreateReaderCheckout500Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout500Response do
  let(:instance) { OpenapiClient::CreateReaderCheckout500Response.new }

  describe 'test an instance of CreateReaderCheckout500Response' do
    it 'should create an instance of CreateReaderCheckout500Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout500Response)
    end
  end
