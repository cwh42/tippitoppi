...
# Unit tests for OpenapiClient::ReceiptTransactionProductsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptTransactionProductsInner do
  let(:instance) { OpenapiClient::ReceiptTransactionProductsInner.new }

  describe 'test an instance of ReceiptTransactionProductsInner' do
    it 'should create an instance of ReceiptTransactionProductsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptTransactionProductsInner)
    end
  end
