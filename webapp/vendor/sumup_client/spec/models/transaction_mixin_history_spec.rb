...
# Unit tests for OpenapiClient::TransactionMixinHistory
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TransactionMixinHistory do
  let(:instance) { OpenapiClient::TransactionMixinHistory.new }

  describe 'test an instance of TransactionMixinHistory' do
    it 'should create an instance of TransactionMixinHistory' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TransactionMixinHistory)
    end
  end
