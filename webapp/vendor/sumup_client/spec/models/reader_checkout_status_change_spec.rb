...
# Unit tests for OpenapiClient::ReaderCheckoutStatusChange
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReaderCheckoutStatusChange do
  let(:instance) { OpenapiClient::ReaderCheckoutStatusChange.new }

  describe 'test an instance of ReaderCheckoutStatusChange' do
    it 'should create an instance of ReaderCheckoutStatusChange' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReaderCheckoutStatusChange)
    end
  end
