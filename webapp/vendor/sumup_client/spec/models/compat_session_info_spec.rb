...
# Unit tests for OpenapiClient::CompatSessionInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CompatSessionInfo do
  let(:instance) { OpenapiClient::CompatSessionInfo.new }

  describe 'test an instance of CompatSessionInfo' do
    it 'should create an instance of CompatSessionInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CompatSessionInfo)
    end
  end
