...
# Unit tests for OpenapiClient::AuthToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthToken do
  let(:instance) { OpenapiClient::AuthToken.new }

  describe 'test an instance of AuthToken' do
    it 'should create an instance of AuthToken' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::AuthToken)
    end
  end
