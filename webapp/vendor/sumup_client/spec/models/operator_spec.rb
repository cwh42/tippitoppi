...
# Unit tests for OpenapiClient::Operator
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Operator do
  let(:instance) { OpenapiClient::Operator.new }

  describe 'test an instance of Operator' do
    it 'should create an instance of Operator' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Operator)
    end
  end
  ...
  describe 'test attribute "account_type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["operator", "normal"])
