...
# Unit tests for OpenapiClient::PaymentInstrumentCard
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PaymentInstrumentCard do
  let(:instance) { OpenapiClient::PaymentInstrumentCard.new }

  describe 'test an instance of PaymentInstrumentCard' do
    it 'should create an instance of PaymentInstrumentCard' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PaymentInstrumentCard)
    end
  end
