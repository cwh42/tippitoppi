...
# Unit tests for OpenapiClient::Affiliate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Affiliate do
  let(:instance) { OpenapiClient::Affiliate.new }

  describe 'test an instance of Affiliate' do
    it 'should create an instance of Affiliate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Affiliate)
    end
  end
  ...
  describe 'test attribute "foreign_transaction_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
