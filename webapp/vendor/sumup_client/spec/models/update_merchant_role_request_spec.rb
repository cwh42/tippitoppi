...
# Unit tests for OpenapiClient::UpdateMerchantRoleRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateMerchantRoleRequest do
  let(:instance) { OpenapiClient::UpdateMerchantRoleRequest.new }

  describe 'test an instance of UpdateMerchantRoleRequest' do
    it 'should create an instance of UpdateMerchantRoleRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateMerchantRoleRequest)
    end
  end
