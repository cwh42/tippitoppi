...
# Unit tests for OpenapiClient::EventStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::EventStatus do
  let(:instance) { OpenapiClient::EventStatus.new }

  describe 'test an instance of EventStatus' do
    it 'should create an instance of EventStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::EventStatus)
    end
  end
