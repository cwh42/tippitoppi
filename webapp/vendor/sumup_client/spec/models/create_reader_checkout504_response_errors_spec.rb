...
# Unit tests for OpenapiClient::CreateReaderCheckout504ResponseErrors
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderCheckout504ResponseErrors do
  let(:instance) { OpenapiClient::CreateReaderCheckout504ResponseErrors.new }

  describe 'test an instance of CreateReaderCheckout504ResponseErrors' do
    it 'should create an instance of CreateReaderCheckout504ResponseErrors' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderCheckout504ResponseErrors)
    end
  end
