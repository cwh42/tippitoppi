...
# Unit tests for OpenapiClient::ErrorExtended
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorExtended do
  let(:instance) { OpenapiClient::ErrorExtended.new }

  describe 'test an instance of ErrorExtended' do
    it 'should create an instance of ErrorExtended' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ErrorExtended)
    end
  end
