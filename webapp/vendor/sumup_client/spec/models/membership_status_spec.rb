...
# Unit tests for OpenapiClient::MembershipStatus
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::MembershipStatus do
  let(:instance) { OpenapiClient::MembershipStatus.new }

  describe 'test an instance of MembershipStatus' do
    it 'should create an instance of MembershipStatus' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::MembershipStatus)
    end
  end
