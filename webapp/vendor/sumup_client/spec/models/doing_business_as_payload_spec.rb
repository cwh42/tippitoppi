...
# Unit tests for OpenapiClient::DoingBusinessAsPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::DoingBusinessAsPayload do
  let(:instance) { OpenapiClient::DoingBusinessAsPayload.new }

  describe 'test an instance of DoingBusinessAsPayload' do
    it 'should create an instance of DoingBusinessAsPayload' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::DoingBusinessAsPayload)
    end
  end
