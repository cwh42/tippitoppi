...
# Unit tests for OpenapiClient::ReceiptMerchantDataMerchantProfile
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ReceiptMerchantDataMerchantProfile do
  let(:instance) { OpenapiClient::ReceiptMerchantDataMerchantProfile.new }

  describe 'test an instance of ReceiptMerchantDataMerchantProfile' do
    it 'should create an instance of ReceiptMerchantDataMerchantProfile' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ReceiptMerchantDataMerchantProfile)
    end
  end
