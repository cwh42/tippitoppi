...
# Unit tests for OpenapiClient::ListMerchantRoles200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ListMerchantRoles200Response do
  let(:instance) { OpenapiClient::ListMerchantRoles200Response.new }

  describe 'test an instance of ListMerchantRoles200Response' do
    it 'should create an instance of ListMerchantRoles200Response' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::ListMerchantRoles200Response)
    end
  end
