...
# Unit tests for OpenapiClient::TransactionFullAllOfLocation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::TransactionFullAllOfLocation do
  let(:instance) { OpenapiClient::TransactionFullAllOfLocation.new }

  describe 'test an instance of TransactionFullAllOfLocation' do
    it 'should create an instance of TransactionFullAllOfLocation' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::TransactionFullAllOfLocation)
    end
  end
