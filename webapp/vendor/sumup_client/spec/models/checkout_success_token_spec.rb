...
# Unit tests for OpenapiClient::CheckoutSuccessToken
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CheckoutSuccessToken do
  let(:instance) { OpenapiClient::CheckoutSuccessToken.new }

  describe 'test an instance of CheckoutSuccessToken' do
    it 'should create an instance of CheckoutSuccessToken' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CheckoutSuccessToken)
    end
  end
