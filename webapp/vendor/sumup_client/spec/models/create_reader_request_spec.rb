...
# Unit tests for OpenapiClient::CreateReaderRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateReaderRequest do
  let(:instance) { OpenapiClient::CreateReaderRequest.new }

  describe 'test an instance of CreateReaderRequest' do
    it 'should create an instance of CreateReaderRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::CreateReaderRequest)
    end
  end

  describe 'test attribute "pairing_code"' do
    it 'should work' do
