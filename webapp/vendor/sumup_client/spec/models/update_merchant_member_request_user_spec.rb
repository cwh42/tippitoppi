...
# Unit tests for OpenapiClient::UpdateMerchantMemberRequestUser
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::UpdateMerchantMemberRequestUser do
  let(:instance) { OpenapiClient::UpdateMerchantMemberRequestUser.new }

  describe 'test an instance of UpdateMerchantMemberRequestUser' do
    it 'should create an instance of UpdateMerchantMemberRequestUser' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::UpdateMerchantMemberRequestUser)
    end
  end
