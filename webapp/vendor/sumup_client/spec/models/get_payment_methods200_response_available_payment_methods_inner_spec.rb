...
# Unit tests for OpenapiClient::GetPaymentMethods200ResponseAvailablePaymentMethodsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::GetPaymentMethods200ResponseAvailablePaymentMethodsInner do
  let(:instance) { OpenapiClient::GetPaymentMethods200ResponseAvailablePaymentMethodsInner.new }

  describe 'test an instance of GetPaymentMethods200ResponseAvailablePaymentMethodsInner' do
    it 'should create an instance of GetPaymentMethods200ResponseAvailablePaymentMethodsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::GetPaymentMethods200ResponseAvailablePaymentMethodsInner)
    end
  end
