...
module OpenapiClient
  class ReceiptMerchantDataMerchantProfileAddress
    ...
    attr_accessor :country_en_name

    attr_accessor :country_native_name
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::ReceiptMerchantDataMerchantProfileAddress` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::ReceiptMerchantDataMerchantProfileAddress`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'country_en_name')
        self.country_en_name = attributes[:'country_en_name']
      end

      if attributes.key?(:'country_native_name')
        self.country_native_name = attributes[:'country_native_name']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          city == o.city &&
          country == o.country &&
          country_en_name == o.country_en_name &&
          country_native_name == o.country_native_name &&
    ...
    def hash
      [address_line1, city, country, country_en_name, country_native_name, post_code, landline].hash
    end
