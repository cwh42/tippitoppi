...
module OpenapiClient
  class MembershipStatus
    ...
    def self.all_vars
      @all_vars ||= [ACCEPTED, PENDING, EXPIRED, DISABLED, UNKNOWN].freeze
    end
    ...
    def build_from_hash(value)
      return value if MembershipStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #MembershipStatus"
    end
  end
end
