  ...
  class MembershipUser
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MembershipUser` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MembershipUser`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'virtual_user')
        self.virtual_user = attributes[:'virtual_user']
      else
        self.virtual_user = nil
      end

      if attributes.key?(:'service_account_user')
        self.service_account_user = attributes[:'service_account_user']
      else
        self.service_account_user = nil
      end
    ...
    def list_invalid_properties
      ...
      if @virtual_user.nil?
        invalid_properties.push('invalid value for "virtual_user", virtual_user cannot be nil.')
      end

      if @service_account_user.nil?
        invalid_properties.push('invalid value for "service_account_user", service_account_user cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @virtual_user.nil?
      return false if @service_account_user.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          virtual_user == o.virtual_user &&
          service_account_user == o.service_account_user &&
    ...
    def hash
      [id, email, mfa_on_login_enabled, virtual_user, service_account_user, disabled_at, nickname, picture, classic].hash
    end
