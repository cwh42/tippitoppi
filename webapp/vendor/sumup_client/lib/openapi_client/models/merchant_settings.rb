...
module OpenapiClient
  ...
  class MerchantSettings
    ...
    # Payout Instrument
    attr_accessor :payout_instrument

    # Whether merchant can make MOTO payments
    attr_accessor :moto_payment

    # Stone merchant code
    attr_accessor :stone_merchant_code

    # Whether merchant will receive daily payout emails
    attr_accessor :daily_payout_email

    # Whether merchant will receive monthly payout emails
    attr_accessor :monthly_payout_email
    ...
    def self.attribute_map
      {
        ...
        :'payout_instrument' => :'payout_instrument',
        :'moto_payment' => :'moto_payment',
        :'stone_merchant_code' => :'stone_merchant_code',
        :'daily_payout_email' => :'daily_payout_email',
        :'monthly_payout_email' => :'monthly_payout_email',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MerchantSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MerchantSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payout_instrument')
        self.payout_instrument = attributes[:'payout_instrument']
      end

      if attributes.key?(:'moto_payment')
        self.moto_payment = attributes[:'moto_payment']
      end

      if attributes.key?(:'stone_merchant_code')
        self.stone_merchant_code = attributes[:'stone_merchant_code']
      end

      if attributes.key?(:'daily_payout_email')
        self.daily_payout_email = attributes[:'daily_payout_email']
      end

      if attributes.key?(:'monthly_payout_email')
        self.monthly_payout_email = attributes[:'monthly_payout_email']
      end
    ...
    def valid?
      ...
      moto_payment_validator = EnumAttributeValidator.new('String', ["UNAVAILABLE", "ENFORCED", "ON", "OFF"])
      return false unless moto_payment_validator.valid?(@moto_payment)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] moto_payment Object to be assigned
    def moto_payment=(moto_payment)
      validator = EnumAttributeValidator.new('String', ["UNAVAILABLE", "ENFORCED", "ON", "OFF"])
      unless validator.valid?(moto_payment)
        fail ArgumentError, "invalid value for \"moto_payment\", must be one of #{validator.allowable_values}."
      end
      @moto_payment = moto_payment
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payout_instrument == o.payout_instrument &&
          moto_payment == o.moto_payment &&
          stone_merchant_code == o.stone_merchant_code &&
          daily_payout_email == o.daily_payout_email &&
          monthly_payout_email == o.monthly_payout_email &&
    ...
    def hash
      [tax_enabled, payout_type, payout_period, payout_on_demand_available, payout_on_demand, printers_enabled, payout_instrument, moto_payment, stone_merchant_code, daily_payout_email, monthly_payout_email, gross_settlement].hash
    end
