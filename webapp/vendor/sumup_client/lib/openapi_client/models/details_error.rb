...
module OpenapiClient
  ...
  class DetailsError
    ...
    attr_accessor :failed_constraints
    ...
    def self.openapi_types
      {
        ...
        :'details' => :'String',
        :'status' => :'Float',
        :'failed_constraints' => :'Array<DetailsErrorFailedConstraintsInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::DetailsError` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::DetailsError`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'failed_constraints')
        if (value = attributes[:'failed_constraints']).is_a?(Array)
          self.failed_constraints = value
        end
      end
    end
    ...
    def hash
      [title, details, status, failed_constraints].hash
    end
