...
module OpenapiClient
  class CompatToken
    ...
    # Space separated list of scopes effective for this token.
    attr_accessor :scope
    ...
    # Used to support the OAuth2 authorization flow handled by gateway.
    attr_accessor :consent_reused
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::CompatToken` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::CompatToken`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'issued_token_type')
      ...
      if attributes.key?(:'consent_reused')
        self.consent_reused = attributes[:'consent_reused']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          consent_reused == o.consent_reused
    end
    ...
    def hash
      [access_token, token_type, expires_in, refresh_token, scope, issued_token_type, account_type, consent_reused].hash
    end
