...
module OpenapiClient
  class Event
    ...
    attr_accessor :deducted_amount

    # Amount of the fee deducted for the event.
    attr_accessor :deducted_fee_amount
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'deducted_amount')
        self.deducted_amount = attributes[:'deducted_amount']
      end

      if attributes.key?(:'deducted_fee_amount')
        self.deducted_fee_amount = attributes[:'deducted_fee_amount']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          deducted_amount == o.deducted_amount &&
          deducted_fee_amount == o.deducted_fee_amount
    end
    ...
    def hash
      [id, transaction_id, type, status, amount, timestamp, fee_amount, installment_number, deducted_amount, deducted_fee_amount].hash
    end
