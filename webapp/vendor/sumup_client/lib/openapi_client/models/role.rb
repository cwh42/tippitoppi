  ...
  class Role
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::Role`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_predefined')
        self.is_predefined = attributes[:'is_predefined']
      else
        self.is_predefined = nil
      end
    ...
    def list_invalid_properties
      ...
      if @permissions.length > 100
        invalid_properties.push('invalid value for "permissions", number of items must be less than or equal to 100.')
      end

      if @is_predefined.nil?
        invalid_properties.push('invalid value for "is_predefined", is_predefined cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @permissions.length > 100
      return false if @is_predefined.nil?
    ...
    def permissions=(permissions)
      ...
      if permissions.length > 100
        fail ArgumentError, 'invalid value for "permissions", number of items must be less than or equal to 100.'
      end
    ...
    def hash
      [id, name, description, permissions, is_predefined, metadata, created_at, updated_at].hash
    end
