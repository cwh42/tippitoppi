...
module OpenapiClient
  class ReaderStatus
    ...
    PAIRED = "paired".freeze
    EXPIRED = "expired".freeze

    def self.all_vars
      @all_vars ||= [UNKNOWN, PROCESSING, PAIRED, EXPIRED].freeze
    end
    ...
    def build_from_hash(value)
      return value if ReaderStatus.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #ReaderStatus"
    end
  end
end
