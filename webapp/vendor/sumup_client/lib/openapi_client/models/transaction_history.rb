  ...
  class TransactionHistory
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::TransactionHistory` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::TransactionHistory`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["PAYMENT", "REFUND", "CHARGE_BACK"])
      return false unless type_validator.valid?(@type)
      card_type_validator = EnumAttributeValidator.new('String', ["VISA", "AMEX", "CUP", "DINERS", "DISCOVER", "ELO", "ELV", "GIROCARD", "HIPERCARD", "JCB", "MAESTRO", "MASTERCARD", "VISA_ELECTRON", "VISA_VPAY", "UNKNOWN"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["PAYMENT", "REFUND", "CHARGE_BACK"])
    ...
    def card_type=(card_type)
      validator = EnumAttributeValidator.new('String', ["VISA", "AMEX", "CUP", "DINERS", "DISCOVER", "ELO", "ELV", "GIROCARD", "HIPERCARD", "JCB", "MAESTRO", "MASTERCARD", "VISA_ELECTRON", "VISA_VPAY", "UNKNOWN"])
    ...
    def hash
      [id, transaction_code, amount, currency, timestamp, status, payment_type, installments_count, product_summary, payouts_total, payouts_received, payout_plan, transaction_id, client_transaction_id, user, type, card_type].hash
    end
