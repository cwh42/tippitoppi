...
module OpenapiClient
  ...
  class AddressWithDetails
    ...
    attr_accessor :country_details

    attr_accessor :timeoffset_details
    ...
    def self.attribute_map
      {
        ...
        :'timeoffset_details' => :'timeoffset_details',
        :'state_id' => :'state_id'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::AddressWithDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::AddressWithDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'country_details')
        self.country_details = attributes[:'country_details']
      end

      if attributes.key?(:'timeoffset_details')
        self.timeoffset_details = attributes[:'timeoffset_details']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          company == o.company &&
          country_details == o.country_details &&
          timeoffset_details == o.timeoffset_details &&
          state_id == o.state_id
    end
    ...
    def hash
      [address_line1, address_line2, city, country, region_id, region_name, region_code, post_code, landline, first_name, last_name, company, country_details, timeoffset_details, state_id].hash
    end
