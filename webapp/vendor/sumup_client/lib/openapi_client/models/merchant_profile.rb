...
module OpenapiClient
  ...
  class MerchantProfile
    ...
    attr_accessor :extdev

    # True if the payout zone of this merchant is migrated
    attr_accessor :payout_zone_migrated
    ...
    def self.attribute_map
      {
        ...
        :'extdev' => :'extdev',
        :'payout_zone_migrated' => :'payout_zone_migrated',
        :'country' => :'country'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `OpenapiClient::MerchantProfile` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `OpenapiClient::MerchantProfile`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'vat_rates')
        self.vat_rates = attributes[:'vat_rates']
      end
      ...
      if attributes.key?(:'extdev')
        self.extdev = attributes[:'extdev']
      end

      if attributes.key?(:'payout_zone_migrated')
        self.payout_zone_migrated = attributes[:'payout_zone_migrated']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          extdev == o.extdev &&
          payout_zone_migrated == o.payout_zone_migrated &&
          country == o.country
    end
    ...
    def hash
      [merchant_code, company_name, website, legal_type, merchant_category_code, mobile_phone, company_registration_number, vat_id, permanent_certificate_access_code, nature_and_purpose, address, business_owners, doing_business_as, settings, vat_rates, locale, bank_accounts, extdev, payout_zone_migrated, country].hash
    end
